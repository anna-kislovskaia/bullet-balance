...
/**
 * Finds less risky portfolio using test MOEX data
 */
public class MoexDemo {

	// ================= MOEX data =========================
	public static Portfolio<String> createPortfolio() {
		...
		builder.add("PHOR", MoexPriceReader.readLastPrices(new CharArrayReader(PHOR.toCharArray())));
